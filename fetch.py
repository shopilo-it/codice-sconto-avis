#!/usr/bin/env python3
"""
Recupero codici sconto Avis Autonoleggio da shopilo.it
Sursa: https://shopilo.it/negozi/avisautonoleggio.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/avisautonoleggio.it"
STORE_NAME = "Avis Autonoleggio"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Avis Autonoleggio da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-avis)"
    }
    try:
