 ...
 * Homepage: https://shopilo.it/negozi/avisautonoleggio.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/avisautonoleggio.it";
const STORE_NAME  = "Avis Autonoleggio";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-avis)" }
  });
